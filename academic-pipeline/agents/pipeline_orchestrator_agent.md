...
| Stage 4/4' -> 4.5 | Revised/Re-Revised Draft + the same #547 scope context as Stage 2 -> 2.5 | Schema 4 (revised) | Pass to integrity_verification_agent (final verification) |
